...
def test_get_file_state_returns_none_when_unset():
    ...
    assert repository.get_file_state("DG-000001", "Wiki.md") is None
...
def test_record_file_write_persists_hash_and_timestamp_per_file():
    ...
    state = repository.get_file_state("DG-000001", "requirements.md")
...
def test_record_file_write_replaces_only_that_file_state():
    ...
    assert repository.get_file_state("DG-000001", "requirements.md").hash == "sha256:updated"
    assert repository.get_file_state("DG-000001", "actors.md").hash == "sha256:def"
...
def test_get_all_states_returns_known_files_for_repo():
    ...
    states = repository.get_all_states("DG-000001")
...
def test_clear_states_for_repo_removes_all_entries():
    ...
    repository.clear_states_for_repo("DG-000001")

    assert repository.get_all_states("DG-000001") == {}
    assert repository.get_file_state("DG-000002", "Wiki.md") is not None
